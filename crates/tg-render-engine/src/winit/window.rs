use nalgebra_glm::{IVec1,Vec2,DVec2,IVec2};
use uuid::{Uuid};
...
use super::raw_window_handle::RawWindowHandleWrapper;
...
impl Window {
    ...
    pub fn cursor_position(&self) -> Option<Vec2> {
        let a = self.physical_cursor_position
            .map(|p| (p / self.scale_factor())).unwrap();
        Some(Vec2::new(a.x as f32,a.y as f32))
    }
